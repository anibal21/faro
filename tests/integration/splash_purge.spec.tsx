...
vi.mock("../../src/lib/ipc", () => ({
  ...
  envSetKeepAlive: vi.fn(async () => ({ instanceId: "", keepAlive: false })),
  envRestoreDemo: vi.fn(),
  demoFixturePaths: vi.fn(),
  k8sListDeployments: vi.fn(async () => []),
  k8sListPods: vi.fn(async () => []),
  k8sListServices: vi.fn(async () => []),
  k8sListConfigmaps: vi.fn(async () => []),
  k8sGetConfigmap: vi.fn(),
  k8sGetDeploymentYaml: vi.fn(),
  k8sGetService: vi.fn(),
